...
<?php
    ...
    $wp_query->query('post_type=bc-videos&posts_per_page='.get_option('posts_per_page').'&paged=' . $paged.'&meta_key=wpcf-videos-channel&meta_value=Bits of 8');
?>
